...
export interface ApiClosedTaskClosedTask extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    closed_tasks: Schema.Attribute.Relation<
      'oneToMany',
      'api::closed-task.closed-task'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::closed-task.closed-task': ApiClosedTaskClosedTask;
